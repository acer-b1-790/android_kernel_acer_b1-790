...
//ISINK0
	        pmic_config_interface(0x010E, 0x0, 0x1, 0); 
	        pmic_config_interface(0x0126, 0x0, 0x1, 10); 
	        pmic_config_interface(0x0330, 0xF, 0x1F, 8); 
	        pmic_config_interface(0x0330, 0x0, 0x3, 2); 
	        pmic_config_interface(0x0332, 0x0, 0xFFFF, 0); 
	        pmic_config_interface(0x0334, 0x3, 0x7, 12); 
	        pmic_config_interface(0x0356, 0x0, 0x1, 4); 

	        pmic_config_interface(0x0356, 0x0, 0x1, 0); 
