...
void GC0328NightMode(kal_bool bEnable)
{
	...
	{	
		...
		if(GC0328_MPEG4_encode_mode == KAL_TRUE)
			GC0328_write_cmos_sensor(0x33, 0x30);//0x00
		else
	...
	else 
	{
		GC0328_write_cmos_sensor(0xfe, 0x01);
		if(GC0328_MPEG4_encode_mode == KAL_TRUE)
			GC0328_write_cmos_sensor(0x33, 0x20);//0x00
		else
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x06, 0x6a); 
	GC0328_write_cmos_sensor(0x07, 0x00);
	GC0328_write_cmos_sensor(0x08, 0x0c);

	GC0328_write_cmos_sensor(0xfe, 0x01);
	GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0328_write_cmos_sensor(0x2a, 0x96);   //anti-flicker step [7:0]

	GC0328_write_cmos_sensor(0x2b, 0x01);   //exp level 0  14.28fps
	GC0328_write_cmos_sensor(0x2c, 0xc2); 
	...
	GC0328_write_cmos_sensor(0x30, 0xee); 
	GC0328_write_cmos_sensor(0x31, 0x05);   //exp level 3  7.14fps
	GC0328_write_cmos_sensor(0x32, 0xdc); 
	GC0328_write_cmos_sensor(0xfe, 0x00);
	*/
	...
	GC0328_write_cmos_sensor(0xfe, 0x00);		
	GC0328_write_cmos_sensor(0x05, 0x00); 	
	GC0328_write_cmos_sensor(0x06, 0x86); 
	GC0328_write_cmos_sensor(0x07, 0x00);
	GC0328_write_cmos_sensor(0x08, 0x0a);

	GC0328_write_cmos_sensor(0xfe, 0x01);
	GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0328_write_cmos_sensor(0x2a, 0x9d);   //anti-flicker step [7:0]

	GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  31.5fps
	GC0328_write_cmos_sensor(0x2c, 0x74); 
	GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  31.5fps
	GC0328_write_cmos_sensor(0x2e, 0x74); 
	GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  25fps
	GC0328_write_cmos_sensor(0x30, 0x74); 
	GC0328_write_cmos_sensor(0x31, 0x02);   //exp level 3  20fps
	GC0328_write_cmos_sensor(0x32, 0x74); 
	GC0328_write_cmos_sensor(0xfe, 0x00);
	////////////Ö¡ÂÊend////////////////
	...
	GC0328_write_cmos_sensor(0x4d, 0x26);    ////////////40  
	GC0328_write_cmos_sensor(0x4e, 0x02);    //SPL D65 
	GC0328_write_cmos_sensor(0x4d, 0x35);    ////////////40  
	GC0328_write_cmos_sensor(0x4e, 0x02);    //SPL D65 
	GC0328_write_cmos_sensor(0x4e, 0x02);    //SPL D65 
	GC0328_write_cmos_sensor(0x4e, 0x02);    //SPL D65 
	...
	GC0328_write_cmos_sensor(0x17 , 0x17);     //14 seaser 20160520
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x2b);//0x32 jon 0x20
	GC0328_write_cmos_sensor(0xd2 , 0x2b);//0x20
	GC0328_write_cmos_sensor(0xd3 , 0x40);//0x30
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
        pSensorInfo->SensorClockFreq=24; //lpf 24
...
BOOL GC0328_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy yintian
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x58); //WB_manual_gain 
			GC0328_write_cmos_sensor(0x78, 0x40);
			GC0328_write_cmos_sensor(0x79, 0x50);
		break;
		
		case AWB_MODE_DAYLIGHT: //sunny  qingtian
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x70); 
			GC0328_write_cmos_sensor(0x78, 0x40);
			GC0328_write_cmos_sensor(0x79, 0x50);			
		break;
		
		case AWB_MODE_INCANDESCENT: //office  baizhideng
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x50);
			GC0328_write_cmos_sensor(0x78, 0x40);
			GC0328_write_cmos_sensor(0x79, 0x60);
		break;
		
		case AWB_MODE_TUNGSTEN: //home wusideng
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x80);
			GC0328_write_cmos_sensor(0x78, 0x45);
			GC0328_write_cmos_sensor(0x79, 0x40);
		break;
		
		case AWB_MODE_FLUORESCENT:/// yingguangdeng
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x72);
			GC0328_write_cmos_sensor(0x78, 0x60);
			GC0328_write_cmos_sensor(0x79, 0x5b);
		break;
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		*/
		...
		GC0328_write_cmos_sensor(0x2b, 0x01);   //exp level 0  31.4fps
		GC0328_write_cmos_sensor(0x2c, 0x3a); 
		GC0328_write_cmos_sensor(0x2d, 0x01);   //exp level 1  31.4fps
		GC0328_write_cmos_sensor(0x2e, 0xd7); 
		GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  25fps
		GC0328_write_cmos_sensor(0x30, 0x74); 
		GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  20fps
		GC0328_write_cmos_sensor(0x32, 0x11); 
		GC0328_write_cmos_sensor(0xfe, 0x00);
			GC0328_SET_PAGE0;
		break;
		default:
     ...
     if (u2FrameRate == 30)
   	{
		...
		GC0328_write_cmos_sensor(0x2b, 0x01);   //exp level 0  31.5fps
		GC0328_write_cmos_sensor(0x2c, 0x3a); 
		GC0328_write_cmos_sensor(0x2d, 0x01);   //exp level 1  31.5fps
		GC0328_write_cmos_sensor(0x2e, 0xd7); 
		GC0328_write_cmos_sensor(0x2f, 0x01);   //exp level 2  25fps
		GC0328_write_cmos_sensor(0x30, 0xd7); 
		GC0328_write_cmos_sensor(0x31, 0x01);   //exp level 3  20fps
		GC0328_write_cmos_sensor(0x32, 0xd7); 
		GC0328_write_cmos_sensor(0xfe, 0x00);
		////////////Ö¡ÂÊend////////////////
		...
		GC0328_write_cmos_sensor(0x2b, 0x03);   //exp level 0  31.5fps
		GC0328_write_cmos_sensor(0x2c, 0x11); 
		GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  31.5fps
		GC0328_write_cmos_sensor(0x2e, 0x11); 
		GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 2  25fps
		GC0328_write_cmos_sensor(0x30, 0x11); 
		GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  20fps
		GC0328_write_cmos_sensor(0x32, 0x11); 
		GC0328_write_cmos_sensor(0xfe, 0x00);
		////////////Ö¡ÂÊend////////////////
		...
		GC0328_write_cmos_sensor(0x2b, 0x03);   //exp level 0  31.5fps
		GC0328_write_cmos_sensor(0x2c, 0x3e); 
		GC0328_write_cmos_sensor(0x2d, 0x03);   //exp level 1  31.5fps
		GC0328_write_cmos_sensor(0x2e, 0xae); 
		GC0328_write_cmos_sensor(0x2f, 0x03);   //exp level 2  25fps
		GC0328_write_cmos_sensor(0x30, 0xae); 
		GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  20fps
		GC0328_write_cmos_sensor(0x32, 0xae); 
		GC0328_write_cmos_sensor(0xfe, 0x00);
		////////////Ö¡ÂÊend////////////////
...
void GC0328_get_AEAWB_lock(unsigned long long *pAElockRet32, unsigned long long *pAWBlockRet32)
{
...
#if 0//defined (ATA_TEST)    add clj 20150516 
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
   ...
   // RETAILMSG(1, (_T("gaiyang GC0328FeatureControl FeatureId=%d\r\n"), FeatureId));
    ...
    case SENSOR_FEATURE_SET_NIGHTMODE:
       // GC0328NightMode((BOOL) *pFeatureData32);
        break;
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		GC0328_get_AEAWB_lock((unsigned long long *)(*feature_data),(unsigned long long *) (*(feature_data + 1))); //yangce added for AE_lock CTS
		break;

    case SENSOR_FEATURE_SET_VIDEO_MODE:    //  lanking
	 GC0328YUVSetVideoMode(*pFeatureData32);
	 break;
    case SENSOR_FEATURE_CHECK_SENSOR_ID:
	GC0328GetSensorID(pFeatureData32);
	break;

#if 0 //defined (ATA_TEST)  clj 20150516
