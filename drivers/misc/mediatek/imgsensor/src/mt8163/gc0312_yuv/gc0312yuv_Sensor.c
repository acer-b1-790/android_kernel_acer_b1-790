...
void GC0312_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
...
UINT32 GC0312GetSensorID(UINT32 *sensorID)
{
    ...
    do {
        *sensorID=((GC0312_read_cmos_sensor(0xf0)<< 8)|GC0312_read_cmos_sensor(0xf1));
        ...
        printk("clj#5Read Sensor ID Fail = 0x%04x\n", *sensorID); 
...
void GC0312_get_AEAWB_lock(unsigned long long *pAElockRet32, unsigned long long *pAWBlockRet32)
{
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
   ...
   // UINT16 *pFeatureData16=(UINT16 *) pFeaturePara;
    ...
    case SENSOR_FEATURE_SET_NIGHTMODE:
      //  GC0312NightMode((BOOL) *pFeatureData32);
        break;
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		GC0312_get_AEAWB_lock((unsigned long long *)(*feature_data),(unsigned long long *) (*(feature_data + 1))); //yangce added for AE_lock CTS
		break;
    case SENSOR_FEATURE_SET_VIDEO_MODE:    //  lanking
	 GC0312YUVSetVideoMode(*pFeatureData32);
	 break;
